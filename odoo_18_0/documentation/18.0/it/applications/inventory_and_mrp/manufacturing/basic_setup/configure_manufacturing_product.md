# Manufacturing product configuration — Odoo 18.0 documentazione
...
The assignment of lots or serial numbers to newly manufactured products is optional. To optionally [assign lots or serial numbers](../../inventory/product_management/product_tracking.html) to newly manufactured products, go to the Traceability section in the Inventory tab. In the Tracking field, select By Unique Serial Number or By Lots.
