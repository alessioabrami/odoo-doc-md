# Link tracker — Odoo 18.0 documentazione

### Navigazione

  * [indice](../../../../genindex.html "Indice generale")
  * [moduli](../../../../py-modindex.html "Indice del modulo Python") |
  * [successivo](../mail_groups.html "Mail groups") |
  * [precedente](analytics.html "Website analytics") |
...
The Link Tracker module is not installed by default. You need to enable the Email Marketing option by going to Website ‣ Configuration ‣ Settings. Alternatively, you can [install](../../../general/apps_modules.html) the Link Tracker module itself or one of the marketing apps.
...
For each parameter available in the [Visibility](../web_design/building_blocks.html#building-blocks-visibility) section, you can choose Visible for or Hidden for and select the record you want from the dropdown list.
