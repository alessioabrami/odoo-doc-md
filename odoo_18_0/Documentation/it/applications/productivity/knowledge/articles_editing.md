# Article creation and editing — Odoo 18.0 documentazione

### Navigazione

  * [indice](../../../genindex.html "Indice generale")
  * [moduli](../../../py-modindex.html "Indice del modulo Python") |
  * [successivo](management.html "Article management") |
...
To create an article from scratch, click New in the top right corner or hover over the Private or Workspace category in the sidebar tree, then click the __(plus) icon. Start typing text or select one of the suggested options:
...
To edit a word, sentence, or paragraph, select or double-click it to display the text editor toolbar and apply the desired [formatting options](../../essentials/html_editor.html).
...
Type `/` to open the [powerbox](../../essentials/html_editor.html#essentials-html-editor-commands) and use a command. The following commands are exclusive to the Knowledge app:
...
To add a cover picture, click the __(ellipsis) icon, then Add Cover. The following options enable selecting and inserting pictures from different sources:
  ...
  * Search the [Unsplash](../../general/integrations/unsplash.html) database to find a suitable picture. If your database and your **Unsplash** account are associated, the cover picture is automatically selected based on the article’s name.
...
Once the view or link is inserted:
  ...
  * Clicking the inserted link opens a pop-up with the view’s name next to the __( copy), __( edit), and __( remove) icons. Click the name inside the pop-up to open the linked view.
