# Modelli — Odoo 18.0 documentazione
...
Any spreadsheet can be saved as a template. Open the relevant spreadsheet or [create a new one](../documents.html#documents-spreadsheet). From the menu bar, click File ‣ Save as template. Modify the default Template Name if needed and click Confirm.
