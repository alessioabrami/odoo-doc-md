# Modalità sviluppatore (modalità di debug) — Odoo 18.0 documentazione
...
### Navigazione
  ...
  * [precedente](integrations/barcodelookup.html "Ricerca codici a barre") |
...
Per attivare la modalità sviluppatore **da qualsiasi punto del database** , aggiungi `?debug=1` alla fine dell’URL (e.g., `https://example.odoo.com/odoo?debug=1`). Per disattivarla, utilizza `?debug=0`.
