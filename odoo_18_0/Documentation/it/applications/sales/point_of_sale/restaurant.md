# Restaurant features — Odoo 18.0 documentazione
...
As soon as you click a table, the number of guests is automatically set to one. If you mistakenly select a table, click Release table to free it or [transfer the customer](restaurant/floors_tables.html#pos-floors-tables-transfer) to another table.
