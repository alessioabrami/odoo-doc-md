# Shipping and receiving — Odoo 18.0 documentazione
...
### Navigazione
  ...
  * [precedente](warehouses_storage/reporting/aging.html "Stock valuation dashboard") |
...
# Shipping and receiving¶
  ...
  * [Delivery methods](shipping_receiving/setup_configuration.html)
    * [Add a new delivery method](shipping_receiving/setup_configuration/new_delivery_method.html)
    ...
    * [Envia.com integration](shipping_receiving/setup_configuration/envia_shipping.html)
    ...
    * [Dispatch management system](shipping_receiving/setup_configuration/dispatch.html)
  ...
  * Picking methods
    ...
    * [Trasferimenti wave](shipping_receiving/picking_methods/wave.html)
...
[ __Edit on GitHub](https://github.com/odoo/Documentation/edit/18.0/content/applications/inventory_and_mrp/inventory/shipping_receiving.rst)
