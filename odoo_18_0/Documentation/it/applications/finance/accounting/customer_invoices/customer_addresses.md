# Indirizzi di consegna e di fatturazione — Odoo 18.0 documentazione
...
Sui preventivi e sugli ordini di vendita ora sono presenti i campi Indirizzo di fatturazione e Indirizzo di consegna. Se nel [record del contatto](../../../sales/sales/sales_quotations/different_addresses.html#sales-send-quotations-contact-form-config) è presente un indirizzo di fatturazione o di consegna, per impostazione predefinita, il campo corrispondente utilizza quell’indirizzo ma è possibile utilizzare l’indirizzo di qualsiasi contatto.

Vedi anche

Per maggiori informazioni, consulta la documentazione [Configurazione di un modulo di contatto](../../../sales/sales/sales_quotations/different_addresses.html#sales-send-quotations-contact-form-config).
...
[ __Edit on GitHub](https://github.com/odoo/documentation/edit/18.0/content/applications/finance/accounting/customer_invoices/customer_addresses.rst)
