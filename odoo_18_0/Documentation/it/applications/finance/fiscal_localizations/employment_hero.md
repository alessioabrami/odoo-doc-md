# Libro paga Employment Hero — Odoo 18.0 documentazione
...
The [Employment Hero](https://employmenthero.com/) module synchronises payslip accounting entries (e.g., expenses, social charges, liabilities, taxes) automatically from Employment Hero to Odoo. Payroll administration is still done in Employment Hero. We only record the **journal entries** in Odoo.
...
## Configurazione¶
  ...
  1. [Activate](../../general/apps_modules.html#general-install) the Employment Hero Payroll module (`l10n_employment_hero`).
  ...
  2. Configure the **Employment Hero API** by going to Accounting ‣ Configuration ‣ Settings. More fields become visible after clicking on Enable Employment Hero Integration.
     ...
     * The **Payroll URL** is left empty by default to avoid any confusion. Please fill it according to the documentation specific to your localization.

Nota

Employment hero is available for [Australia](../../hr/payroll/payroll_localizations/australia.html#payroll-l10n-au-employment-hero), [Malaysia](malaysia.html#malaysia-employment-hero), [New Zealand](new_zealand.html#new-zealand-employment-hero), [Singapore](singapore.html#singapore-employment-hero), and the [United Kingdom](united_kingdom.html#localization-united-kingdom-employment-hero).
