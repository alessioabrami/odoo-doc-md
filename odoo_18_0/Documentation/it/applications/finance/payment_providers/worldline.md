...
[Worldline](https://worldline.com/) is a France-based company and the world’s fourth largest payment provider.
...
To create an **API user** , proceed as follows:
  ...
  1. Log into your [Worldline Merchant Portal](https://merchant-portal.preprod.worldline-solutions.com/dashboard), click the __( menu) icon, and select Back Office.
...
To set up Worldline in Odoo:
  ...
  1. [Navigate to the payment provider Worldline](../payment_providers.html#payment-providers-add-new) and change its state to Enabled.
