# ORM API — Odoo 18.0 documentazione
...
Model.with_company(_company_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6310)¶
...
Model.create(_vals_list_) → records[[sorgente]](https://github.com/odoo/odoo/blob/documentation-user/<decorator-gen-0>#L4932)¶
...
Model.default_get(_fields_list_) → default_values[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L1633)¶
...
Model.unlink()[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L4513)¶
...
Model.exists() → records[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L5956)¶
...
Model.ensure_one() → Self[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6243)¶
...
Model.get_metadata()[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L4252)¶
...
Model.filtered(_func_) → Self[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6502)¶
...
Model.filtered_domain(_domain_) → Self[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6553)¶
...
Model.mapped(_func_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6463)¶
...
Model.sorted(_key =None_, _reverse =False_) → Self[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6710)¶
...
Model.grouped(_key_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/models.py#L6525)¶
...
_exception _odoo.exceptions.UserError(_message_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L16)¶
...
_exception _odoo.exceptions.RedirectWarning(_message_ , _action_ , _button_text_ , _additional_context =None_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L30)¶
...
_exception _odoo.exceptions.AccessDenied(_message ='Access Denied'_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L45)¶
...
_exception _odoo.exceptions.AccessError(_message_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L64)¶
...
_exception _odoo.exceptions.CacheMiss(_record_ , _field_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L73)¶
...
_exception _odoo.exceptions.MissingError(_message_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L85)¶
...
_exception _odoo.exceptions.ValidationError(_message_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/odoo/exceptions.py#L94)¶
