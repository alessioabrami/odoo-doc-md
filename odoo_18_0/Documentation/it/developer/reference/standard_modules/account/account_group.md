# Account Group — Odoo 18.0 documentazione
...
_model _odoo.addons.account.models.account_account.AccountGroup(_env : api.Environment_, _ids : [tuple](https://docs.python.org/3/library/stdtypes.html#tuple "\(in Python v3.13\)")[IdType, ...]_, _prefetch_ids : Reversible[IdType]_)[[sorgente]](https://github.com/odoo/odoo/blob/18.0/addons/account/models/account_account.py#L1447)¶
