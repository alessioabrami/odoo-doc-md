# Configure reordering rules — Odoo 18.0 documentazione
...
Next, on the product form, enable reordering by ticking the Purchase checkbox underneath the Product name field. Then, under the General Information tab, set the Product Type to Goods. Finally, tick the checkbox labeled Track Inventory, and select an [option](../../inventory/product_management/product_tracking.html) from the drop-down.
