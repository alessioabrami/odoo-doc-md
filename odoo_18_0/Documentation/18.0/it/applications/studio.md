# Studio — Odoo 18.0 documentazione
...
# Studio¶
  ...
  * [Regole di automazione](studio/automated_actions.html)
    * [Webhook](studio/automated_actions/webhooks.html)
  * [Reportistica in PDF](studio/pdf_reports.html)
  * [Regole di approvazione](studio/approval_rules.html)



**Studio** è uno strumento utilizzato per personalizzare Odoo senza conoscenze di codifica. Ad esempio, in ogni app, puoi aggiungere o modificare:
...
Impara come [creare un’app a partire da zero](studio/models_modules_apps.html).

Per accedere a Studio, apri l’app e il modello che vuoi modificare per poi fare clic sull’icona __( Toggle Studio) o viceversa.
