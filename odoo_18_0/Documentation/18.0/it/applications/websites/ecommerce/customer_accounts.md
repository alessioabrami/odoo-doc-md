# Customer accounts — Odoo 18.0 documentazione
...
Customers can only have an account if the [sign in/up at checkout](checkout.html#ecommerce-checkout-policy) option allows for account creation.
