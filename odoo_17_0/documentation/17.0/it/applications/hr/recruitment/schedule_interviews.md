# Schedule interviews — Odoo 17.0 documentazione
...
To send the meeting via text message, click the __ SMS button next to the Attendees field on the expanded meeting form. A Send SMS Text Message pop-up window appears.
...
[ __Edit on GitHub](https://github.com/odoo/documentation/edit/17.0/content/applications/hr/recruitment/schedule_interviews.rst)
