# Da fare — Odoo 17.0 documentazione

### Navigazione

  * [indice](../../genindex.html "Indice generale")
  * [moduli](../../py-modindex.html "Indice del modulo Python") |
  * [successivo](../studio.html "Studio") |
  * [precedente](voip/transfer_forward.html "Make, receive, transfer, and forward calls") |
...
If you use the [Project app](../services/project.html), you can convert to-dos into project tasks. To do so, open a to-do and click the gear button (⚙), then Convert to Task.
...
If you use the [Project app](../services/project.html), your to-dos also appear as private tasks under the My Tasks view.

Nota

A padlock icon is visible on your private tasks to quickly identify them among your project tasks.

[ __Edit on GitHub](https://github.com/odoo/documentation/edit/17.0/content/applications/productivity/to_do.rst)
