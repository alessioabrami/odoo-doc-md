# Odoo Sign legality in Oman — Odoo 17.0 documentazione
...
[Odoo Sign](../sign.html) is your trusted partner for secure, efficient, and legally compliant electronic signatures in Oman.

## Legal framework for electronic signatures in Oman¶

In Oman, electronic signatures are regulated under the Electronic Transactions Law. The law establishes the legal basis for acknowledging electronic records, contracts, and digital signatures. The key points of the law include:
...
Odoo Sign ensures full compliance with the Electronic Signature Law of Oman by incorporating the following features:
...
While Odoo Sign is broadly applicable, there are certain exceptions where electronic signatures may not be suitable or legally recognized in Oman:
...
[ __Edit on GitHub](https://github.com/odoo/documentation/edit/17.0/content/applications/productivity/sign/oman.rst)
