# IP geo — Odoo 17.0 documentazione

### Navigazione

  * [indice](../../genindex.html "Indice generale")
  * [moduli](../../py-modindex.html "Indice del modulo Python") |
  * [successivo](community_to_enterprise.html "Passare da Community a Enterprise") |
  * [precedente](email_gateway.html "Gateway di posta elettronica") |
...
Se non vuoi/puoi spostare il database geoip in `/usr/share/GeoIP/`, utilizza le opzioni [`--geoip-city-db`](../../developer/reference/cli.html#cmdoption-odoo-bin-geoip-city-db) e [`--geoip-country-db`](../../developer/reference/cli.html#cmdoption-odoo-bin-geoip-country-db) dell’interfaccia della riga di comando di Odoo. Le opzioni prendono il percorso assoluto del file del database Odoo e lo utilizzano come database GeoIP. Ad esempio:
...
Vedi anche
  ...
  * [Documentazione CLI](../../developer/reference/cli.html).
...
Se leggi «**geoip failure** » significa che la geolocalizzazione non è riuscita. Le cause più comuni sono:
  ...
  2. Stai utilizzando un proxy invertito (apache, nginx) di fronte a Odoo ma non hai avviato Odoo con la modalità proxy attivata. Consulta la sezione [`modalità proxy`](../../developer/reference/cli.html#cmdoption-odoo-bin-proxy-mode).
...
[ __Edit on GitHub](https://github.com/odoo/documentation/edit/17.0/content/administration/on_premise/geo_ip.rst)
